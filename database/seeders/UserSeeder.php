...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ['role_id' => '1', 'user_name' => 'afiq', 'user_ic' => '44444444', 'email' => '1@gmail.com', 'password' => Hash::make('11111111'), 'user_gender' => 'Men', 'user_contact' => '0111111111', 'user_verification' => 'testing.pdf', 'created_at' => $now, 'updated_at' => $now],
